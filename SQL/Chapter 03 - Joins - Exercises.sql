...
From HR.Employees as Emp 
	Cross Join dbo.Nums as Num 
Where Num.n <= 5;

-- solutio 2
Select Emp.empid, Emp.firstname, Emp.lastname, Num.n
From HR.Employees as Emp 
	Cross Join (Select n From dbo.Nums Where n<=5) Num;
...
Select Emp.empid, Dateadd(day, Num.n-1, '2009-06-12') as dt
From HR.Employees as Emp 
	Cross Join dbo.Nums as Num
Where Num.n <= DATEDIFF(day, '2009-06-12', '2009-06-16')+1
Order by Emp.empid, Num.n;

Select a.empid, Dateadd(day, b.n, '2009-06-11') as dt from HR.Employees as a cross join dbo.Nums as b
where b.n <= 5
Order by a.empid
...
Select SO.custid, COUNT(Distinct SO.orderid) as numorders, Sum(SOD.qty) as totalqty
From Sales.Orders as SO
	Left Outer Join Sales.Customers as SC
...
/*
Order By 
	Case when SO.orderid is NULL then 1 else 0 end, SO.orderid
*/
...
On SO.custid = SC.custid
--Where Day(SO.orderdate) = 12 and Month(SO.orderdate) = 2 and YEAR(SO.orderdate) = 2007
Where SO.orderdate = '2007-02-12'
--Where Convert(VARCHAR, SO.orderdate, 120) Like '2007-02-12%'
Order By SO.orderid
...
From Sales.Customers as SC
	Left Outer Join Sales.Orders as SO
		on SC.custid  = SO.custid and SO.orderdate= '2007-02-12'
--Where SO.orderdate = '2007-02-12'
...
Select SC.custid, SC.companyname,HasOrderOn20070212 = 
	Case
		When SO.orderdate = '2007-02-12' Then 'Yes'
		Else 'No'
	End
From Sales.Customers as SC
	Left Outer Join Sales.Orders as SO
